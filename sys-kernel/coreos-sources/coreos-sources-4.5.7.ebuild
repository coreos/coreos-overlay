...
UNIPATCH_LIST="
        ...
        ${PATCH_DIR}/z0021-netfilter-x_tables-make-sure-e-next_offset-covers-re.patch \
        ${PATCH_DIR}/z0022-netfilter-x_tables-validate-e-target_offset-early.patch \
        ${PATCH_DIR}/z0023-netfilter-x_tables-check-for-bogus-target-offset.patch
"
